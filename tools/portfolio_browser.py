    ...
    if edges:
        ...
        for edge in edges:
            ...
            edge_cards.append(f'''<article class="connection-card">
              <div class="connection-flow"><div class="endpoint subject">{_text(subject_type)}</div><code class="edge-type">{_text(edge_type)}</code><div class="endpoint target">{_text(target_type)}</div></div>
              <details class="edge-details"><summary>Details</summary><dl><dt>Edge ID</dt><dd><code>{_text(edge.get("internal_edge_id") or "Not recorded")}</code></dd>
              ...
              <dt>Source</dt><dd>{source_html}</dd></dl></details></article>''')
