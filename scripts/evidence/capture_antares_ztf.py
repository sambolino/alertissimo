...
SCRIPT=Path(__file__).resolve(); SURVEY="ztf"; DEFAULT_OID="ZTF20aafqubg"; DEFAULT_LOCUS="ANT2020nb5h6"; ENV_OID="ANTARES_ZTF_OID"
...
def main():
 ...
 out,at=prepare_output(a.output_dir,"antares-ztf"); oid=os.environ.get(ENV_OID,DEFAULT_OID); locus_id=os.environ.get("ANTARES_ZTF_LOCUS_ID",DEFAULT_LOCUS)
 try:
