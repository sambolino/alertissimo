...
SCRIPT=Path(__file__).resolve(); SURVEY="lsst"; DEFAULT_OID="170587117485817955"; ENV_OID="ANTARES_LSST_OID"
...
def main():
 ...
 out,at=prepare_output(a.output_dir,"antares-lsst"); oid=os.environ.get(ENV_OID,DEFAULT_OID)
 try:
