...
Alertissimo is a flexible and inclusive platform for orchestrating astronomical alert streams across the time-domain sky. Designed to unify outputs from brokers like Lasair, AMPEL, Fink, and others, it allows scientists to build custom workflows for filtering, classification, and decision-making — using natural language, a domain-specific language, or visual block building.

The registry-backed physical endpoint execution layer is documented in
[`docs/endpoint_executor.md`](docs/endpoint_executor.md).
